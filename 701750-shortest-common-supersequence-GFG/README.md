...
## Medium
<hr>Given two strings s1 and s2, find the length of the smallest string which has both s1 and s2 as its sub-sequences.Note: s1 and s2&nbsp;can have both uppercase and lowercase English letters.
Examples:
